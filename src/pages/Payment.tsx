    ...
    return (
      <div className="flex flex-col">
        ...
        <div className=" relative w-full flex">
          <img className="w-full blur-3xl h-[80vh]" src={`https://maroon-fashionable-warbler-188.mypinata.cloud/ipfs/${data[parseInt(id)]?.ipfsHash?.replace("ipfs://", "")}?pinataGatewayToken=gVQfpvbN3IXW52kARQuLO50y78ginsP31oSkPQT78K23fingxRmnt7u0tHk2lnFk`} />
          <div className="absolute h-[80vh] w-full flex">
            <div className="w-3/5 h-full flex justify-center items-center">
              <img src={`https://maroon-fashionable-warbler-188.mypinata.cloud/ipfs/${data[parseInt(id)].ipfsHash.replace("ipfs://", "")}?pinataGatewayToken=gVQfpvbN3IXW52kARQuLO50y78ginsP31oSkPQT78K23fingxRmnt7u0tHk2lnFk`} alt="Error Pic" className="object-cover rounded-xl h-full w-11/12 m-auto" />
            </div>
